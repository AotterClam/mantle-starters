/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.mantle/empty.env --strict-vars=false .mantle/generated/env.d.ts` (hash: e5843f2ce8643b8d4a47f79a6e41bc52)
...
interface __BaseEnv_Env {
	...
	MANTLE_SITE_BRAND: string;
	MANTLE_SITE_DESCRIPTION: string;
	MANTLE_SITE_LOCALES: string[];
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "MANTLE_SITE_BRAND" | "MANTLE_SITE_DESCRIPTION" | "MANTLE_SITE_LOCALES">> {}
}
